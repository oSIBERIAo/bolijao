...
$(document).ready(function(e) {
    ...
    var ml=$("http://localhost:8888/skin/js/.prosel_nei div.on").offset().left;
	var w=$("http://localhost:8888/skin/js/.prosel_nei div.on").width();
	...
	$(".prosel_nei div").hover(function(){
	   ...
	   $(".prosel_xian div").css({"margin-left":ml,"width":w}); 	
		...
		ml=$("http://localhost:8888/skin/js/.prosel_nei div.on").offset().left;
		w=$("http://localhost:8888/skin/js/.prosel_nei div.on").width();
		$(".prosel_xian div").css({"margin-left":ml,"width":w});
